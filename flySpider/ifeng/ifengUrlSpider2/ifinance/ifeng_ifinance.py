...
if __name__ == '__main__':
    ...
    max_deep = 100
    cacheFilePath = '/home/dev/Repository_Test_Data/ifeng/log/ifinance/cache.txt'
    finishedIdPath = '/home/dev/Repository_Test_Data/ifeng/log/ifinance/finished_id.csv'
