...
class HuxiuSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        if len(not_fnd) != 1:
            ...
            comment_number = filter(str.isdigit,article.xpath(".//*[@class='article-pl']/text()").extract()[0].encode('gbk'))
            share_number = filter(str.isdigit,article.xpath(".//*[@class='article-share']/text()").extract()[0].encode('gbk'))
            ...
            time = article.xpath(".//*[@class='article-time']/text()").extract()[0]
