...
class UpdateProductionClass():
    ...
    def predictClass(self, filein_path, fileout_path, model_path):
        ...
        for content in content_list:
            ...
            save_items = [content[6], content[3], content[2]] + catalogs
            save_header = ['id', 'title', 'url', 'most', 'mostPossible']
            print content[6] + '--' + content[3] + '--' + catalogs[0] + '--' + catalogs[1]
...
if __name__ == "__main__":
    filein = '/home/dev/Data/rsyncData/prd1/ifeng/ifeng_content.csv'
    model = '/home/dev/Data/npl/classifier/fastText/model_data/news_fasttext.model.bin'
    fileout = '/home/dev/Data/rsyncData/prd1/ifeng/classes.csv'
