...
class Stcn():
    def getSettings(self):
        self.work_path_prd1 = Settings.STCN['WORK_PATH_PRD1']
        self.finished_txt_path = Settings.STCN['FINISHED_TXT_PATH']
        self.finished_id_path = Settings.STCN['FINISHED_ID_PATH']
        self.url_path = Settings.STCN['URL_PATH']
        self.mongo = Settings.STCN['MONGO']
