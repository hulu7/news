...
class Sohump():
    ...
    def getSettings(self):
        self.settings = self.globalSettings.CreateSettings('sohump')
    ...
    def parse(self, response):
        ...
        current_id = short_url_parts[short_url_parts.index('a') + 1]
        html = etree.HTML(response['response'].page_source)
        article_content = html.xpath(".//*[contains(@data-spm,'content')]")
        data = {}
        url = ""
        content = ""
        time = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@data-spm,'content')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'article')]//p//text()")
                time0_1 = html.xpath(".//*[contains(@id, 'news-time')]/text()")
                author_name0_1 = self.name
                title0_1 = html.xpath(".//*[contains(@class,'text-title')]/h1/text()")
                images0_1 = html.xpath(".//*[contains(@class, 'article')]//p//img//@src")
