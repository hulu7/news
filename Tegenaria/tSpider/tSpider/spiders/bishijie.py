...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('bishijie', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.bishijie\.com\/shendu\/[0-9]{0,}.html")
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@class,'articles-detail-wrap')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@class,'articles-detail-wrap')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'article-text')]//p//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'articles-info-time')]//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'detail-title')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'article-text')]//img/@src")
