...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('pmcaff', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/coffee\.pmcaff\.com\/article\/[0-9a-zA-Z\_\=\?]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'content')]//p//text()")
            time0_1 = ''.join(article_0[0].xpath(".//*[contains(@class, 'time')]//text()"))
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class,'head')]//*[contains(@class,'title')]//text()")
