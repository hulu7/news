...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('ifanr', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.ifanr\.com\/(app\/)?[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@id,'article-content-wrapper')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@id,'article-content-wrapper')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'c-article-content')]//p//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'c-article-header-meta__time')]//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'c-single-normal__title')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'c-article-content')]//img/@src")
