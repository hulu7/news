...
class I36kr():
    ...
    def getSettings(self):
        self.settings = self.globalSettings.CreateSettings('i36kr')
    ...
    def parse(self, response):
        ...
        if len(not_fnd) > 0:
            ...
            if len(article_0) > 0:
                ...
                images0_1 = html.xpath(".//*[contains(@class, 'articleDetailContent')]//p//img//@src")
                images0_2 = html.xpath(".//*[contains(@class, 'articleDetailContent')]//img//@src")
