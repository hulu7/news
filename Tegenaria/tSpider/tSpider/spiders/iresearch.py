...
class Iresearch():
    ...
    def getSettings(self):
        self.settings = self.globalSettings.CreateSettings('iresearch')
    ...
    def parse(self, response):
        ...
        not_fnd = html.xpath(".//*[contains(@class,'m-cont-hd')]")
        data = {}
        url = ""
        content = ""
        time = ""
        ...
        if len(not_fnd) > 0:
            ...
            if len(article_0) > 0:
                ...
                images0_1 = html.xpath(".//*[contains(@class, 'm-article')]//p//img//@src")
