...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('btc798', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.btc798\.com\/articles\/[0-9]{0,}.html")
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@class,'summit')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@class,'summit')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'summs')]//*//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'summi')]//ul//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'summi')]/h1/text()")
                images0_1 = html.xpath(".//*[contains(@class, 'summs')]//img/@src")
