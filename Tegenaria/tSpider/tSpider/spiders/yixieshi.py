...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('yixieshi', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.yixieshi\.com\/[0-9\-]{0,}.html")
    ...
    def parse(self, current_url, html):
        ...
        current_id = short_url_parts[short_url_parts.index('yixieshi') + 2]
        url = ""
        content = ""
        time = ""
        author_name = ""
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'post-main')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'article-content')]//p//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'article-meta')]//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'post-title')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'article-content')]//figure//img/@src")
