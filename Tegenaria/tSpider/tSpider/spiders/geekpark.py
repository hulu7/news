...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('geekpark', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.geekpark\.net\/news\/[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        if len(article_content) > 0:
            ...
            if len(article_0) > 0:
                ...
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'release-date')]//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//h1[contains(@class,'topic-title')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'topic-cover')]//img/@src")
                images0_2 = html.xpath(".//*[contains(@class, 'image-desc')]//img/@src")
