...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('iyunying', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.iyunying\.org\/([a-zA-Z]{0,}\/)?[a-zA-Z]{0,}\/[0-9]{0,}.html")
    ...
    def parse(self, current_url, html):
        ...
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'entry-content')]//p//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'entry-info')]//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'entry-title')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'entry-content')]//img/@src")
