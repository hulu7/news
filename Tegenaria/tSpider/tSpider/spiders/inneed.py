...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('inneed', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.inneed\.club\/articles\/detail\/[0-9a-zA-Z]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        current_id = short_url_parts[short_url_parts.index('detail') + 1]
        url = ""
        content = ""
        time = ""
        author_name = ""
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'resourcesDetail_box')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'content_detail')]//p//text()")
            time0_1 = self.spiderBone.today
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class,'header_item')]//*[contains(@class,'title')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'content_detail')]//img/@src")
