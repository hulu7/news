...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('chainfor', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.chainfor\.com\/news\/show\/[0-9]{0,}.html")
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@class,'m-i-article')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@class,'m-i-article')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'm-i-bd')]//*//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'm-i-type-timer')]//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'m-i-title')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'm-i-bd')]//img/@src")
