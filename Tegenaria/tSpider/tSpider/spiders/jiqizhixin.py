...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('jiqizhixin', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.jiqizhixin\.com\/articles\/[0-9\-]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'article')]//*[contains(@class, 'u-min-height-container u-container')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'article__content')]//*//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'article__published')]//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'article__title')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'article__content')]//img/@src")
