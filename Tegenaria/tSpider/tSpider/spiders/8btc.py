...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('8btc', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.8btc\.com\/article\/[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        if len(article_content) > 0:
            ...
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'bbt-html')]//*//text()")
                time0_1 = ''.join(html.xpath(".//time//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'bbt-container')]/h1/text()")
                images0_1 = html.xpath(".//*[contains(@class, 'bbt-html')]//img/@src")
