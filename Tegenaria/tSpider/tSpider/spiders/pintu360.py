...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('pintu360', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.pintu360\.com\/[0-9a-zA-Z]{0,}.html\?s\=[0-9\,]{0,}\&o\=[0-9\,]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        current_id = short_url_parts[short_url_parts.index('pintu360') + 2]
        url = ""
        content = ""
        time = ""
        author_name = ""
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'article-body-wrap')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'text')]//p//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'article-date')]//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'article-title-and-type')]//*[contains(@class, 'title')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'article-content')]//*[contains(@class, 'text')]//img/@src")
