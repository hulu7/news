...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('leiphone', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.leiphone\.com\/news\/[0-9]{0,}\/[0-9a-zA-Z]{0,}.html")
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@class,'article-template')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@class,'article-template')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'lph-article-comView')]//*//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'time')]/text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'headTit')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'lph-article-comView')]//img//@src")
