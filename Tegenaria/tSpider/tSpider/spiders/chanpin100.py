...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('chanpin100', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.chanpin100\.com\/article\/[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        if len(article_0) > 0:
            content0_1 = html.xpath(".//*[contains(@class, 'article-content-container')]//p//text()")
            time0_1 = ''.join(article_0[0].xpath(".//*[contains(@class, 'date')]//text()"))
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class,'article-title')]//h2//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'article-content-container')]//img/@src")
