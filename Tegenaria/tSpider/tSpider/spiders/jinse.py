...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('jinse', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.jinse\.com\/(news\/)?blockchain\/[0-9]{0,}.html")
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@class,'js-article')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@class,'js-article')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'js-article')]//*//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'js-article-author')]//span/text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'js-left')]/h1/text()")
                images0_1 = html.xpath(".//*[contains(@class, 'js-article')]//img/@src")
