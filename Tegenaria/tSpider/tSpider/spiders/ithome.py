...
class Spider():
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@role,'article')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@role,'article')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'news-content')]//p//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'news-time')]//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@role,'article')]//*[contains(@class,'title')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'news-content')]//img/@data-original")
