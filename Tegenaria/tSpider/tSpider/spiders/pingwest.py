...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('pingwest', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.pingwest\.com\/a\/[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        current_id = short_url_parts[short_url_parts.index('pingwest') + 3]
        url = ""
        content = ""
        time = ""
        author_name = ""
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'article-row')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'article-style')]//*//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'publish-time')]//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'article-title')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'article-style')]//img/@src")
