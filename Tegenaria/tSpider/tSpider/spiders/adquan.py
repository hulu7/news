...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('adquan', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.adquan\.com\/post-[0-9]{0,}-[0-9]{0,}\.html")
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@class,'txt_box')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@class,'txt_box')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'con_Text')]//*//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'text_time2')]//*//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'text_title')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'con_Text')]//img/@src")
