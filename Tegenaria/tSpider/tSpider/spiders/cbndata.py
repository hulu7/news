...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('cbndata', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/cbndata\.com\/information\/[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        current_id = short_url_parts[short_url_parts.index('information') + 1]
        url = ""
        content = ""
        time = ""
        author_name = ""
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'detail-wrapper')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'content')]//*//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'date')]//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'header')]//*[contains(@class, 'title')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'content')]//img/@src")
