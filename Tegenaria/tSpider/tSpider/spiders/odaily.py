...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('odaily', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.odaily\.com\/post\/[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, '_3739r7Mk')]//p//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@itemprop, 'dateCreated')]//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@itemprop, 'headline')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, '_3739r7Mk')]//img/@src")
