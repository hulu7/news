...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('mcnjigou', callback=self.parse)
    ...
    def parse(self, current_url, html):
        ...
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'mainbody')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'article_content')]//*//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'title')]//span//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'title')]/h1//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'article_content')]//img/@src")
