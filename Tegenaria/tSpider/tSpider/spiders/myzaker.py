...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('myzaker', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/www\.myzaker\.com\/article\/[0-9a-zA-Z]{0,}/")
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@class,'container')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@class,'container')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'article_content')]//*//text()")
                time0_1 = ''.join(html.xpath(".//*[contains(@class, 'sub-line')]//*[contains(@class, 'time')]//text()"))
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//h1[contains(@class,'article-title')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'content_img_div')]//img/@data-original")
