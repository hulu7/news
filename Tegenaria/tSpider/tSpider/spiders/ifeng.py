...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('ifeng', callback=self.parse)
    ...
    def parse(self, current_url, html):
        ...
        article_content0 = html.xpath(".//*[contains(@class,'container-2ItVJon-')]")
        article_content1 = html.xpath(".//*[contains(@class,'artical-_Qk9Dp2t')]")
        article_content2 = html.xpath(".//*[contains(@class,'artical-2gdTPy_p')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content0) > 0:
            ...
            if len(article_0) > 0:
                ...
                images0_1 = html.xpath(".//*[contains(@class, 'text-3zQ3cZD4')]//p//img//@src")
                ...
                data = self.doraemon.createSpiderData(url.strip(),
                                                      ...
                                                      content)
        if len(article_content1) > 0:
            article_0 = html.xpath(".//*[contains(@class,'artical-_Qk9Dp2t')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'text-3zQ3cZD4')]//*//text()")
                time0_1 = html.xpath(".//*[contains(@class, 'time-hm3v7ddj')]//*//text()")
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'topic-3bY8Hw-9')]/text()")
                images0_1 = html.xpath(".//*[contains(@class, 'text-3zQ3cZD4')]//p/img/@src")
                ...
                data = self.doraemon.createSpiderData(url.strip(),
                                                      ...
                                                      self.spiderBone.is_open_cache,
                                                      content)
        if len(article_content2) > 0:
            article_0 = html.xpath(".//*[contains(@class,'artical-2gdTPy_p')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'text-3zQ3cZD4')]//*//text()")
                time0_1 = html.xpath(".//*[contains(@class, 'date-2Z2fH9A1')]/text()")
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'topic-1Q4xfaaR')]/text()")
                images0_1 = html.xpath(".//*[contains(@class, 'text-3zQ3cZD4')]//p/img/@src")
