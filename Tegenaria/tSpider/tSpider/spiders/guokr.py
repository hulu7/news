...
class Spider():
    def __init__(self):
        ...
        self.regx = re.compile("(http(s?):)?\/\/www\.guokr\.com\/article\/[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'Article__StyleWrapper')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'ArticleContent')]//p//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'BlockWrap')]/p/text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'ArticleTitle')]//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'ArticleContent')]//img/@src")
