...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('yunyingpai', callback=self.parse)
    ...
    def parse(self, current_url, html):
        ...
        article_content = html.xpath(".//*[contains(@class,'postArticle')]")
        url = ""
        content = ""
        time = ""
        author_name = ""
        ...
        if len(article_content) > 0:
            article_0 = html.xpath(".//*[contains(@class,'postArticle')]")
            if len(article_0) > 0:
                content0_1 = html.xpath(".//*[contains(@class, 'grap')]//*//text()")
                time = self.spiderBone.today
                author_name0_1 = self.spiderBone.name
                title0_1 = html.xpath(".//*[contains(@class,'title--leading')]//text()")
                images0_1 = html.xpath(".//*[contains(@class, 'grap')]//img//@src")
