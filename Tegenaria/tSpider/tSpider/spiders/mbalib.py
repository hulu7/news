...
class Spider():
    def __init__(self):
        ...
        self.spiderBone = SpiderBone('mbalib', callback=self.parse)
        self.regx = re.compile("(http(s?):)?\/\/news.mbalib\.com\/story\/[0-9]{0,}")
    ...
    def parse(self, current_url, html):
        ...
        current_id = short_url_parts[short_url_parts.index('story') + 1]
        url = ""
        content = ""
        time = ""
        author_name = ""
        title = ""
        id = ""
        article_0 = html.xpath(".//*[contains(@class, 'single-post')]")
        if len(article_0) > 0:
            content0_1 = article_0[0].xpath(".//*[contains(@class, 'single-post-article')]//*//text()")
            time0_1 = article_0[0].xpath(".//*[contains(@class, 'time-ico')]//text()")
            author_name0_1 = self.spiderBone.name
            title0_1 = article_0[0].xpath(".//*[contains(@class, 'single-post-header')]//h1//text()")
            images0_1 = article_0[0].xpath(".//*[contains(@class, 'single-post-toppic')]//img/@src")
