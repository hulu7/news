...
class Qdaily():
    ...
    def getSettings(self):
        self.settings = self.globalSettings.CreateSettings('qdaily')
        ...
        self.regx = re.compile("/articles/[0-9]{0,}.html")
    ...
    def parse(self, response):
        ...
        for item in href_items:
            ...
            if valid:
                ...
                id = short_url_parts[short_url_parts.index('articles') + 1]
                url = urlparse.urljoin(current_url, href_url)
                title = ""
                title_list1 = item.xpath(".//*[contains(@class, 'smart-dotdotdot')]/text()")
                title_list2 = item.xpath(".//*[contains(@class, 'title')]/text()")
