...
class Camel():
    def __init__(self):
        ...
        self.camelBone = CamelBone('inneed', callback=self.parse)
        self.regx = re.compile("\/articles\/detail\/[0-9a-zA-Z]{0,}")
        self.badkeys = []
        self.goodkeys = []
    ...
    def parse(self, current_url, html):
        ...
        for item in href_items:
            ...
            if valid:
                ...
                id = short_url_parts[short_url_parts.index('detail') + 1]
                url = urlparse.urljoin(current_url, href_url)
                title = ""
                title0_1 = item.xpath(".//*[contains(@class, 'coltitle')]//text()")
                if len(title0_1) > 0:
