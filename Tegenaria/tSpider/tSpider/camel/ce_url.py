...
class Ce():
    def getSettings(self):
        self.work_path_prd2 = Settings.CE['WORK_PATH_PRD2']
        self.finished_url_path = Settings.CE['FINISHED_URL_PATH']
        self.mongo = Settings.CE['MONGO_URLS']
        self.name = Settings.CE['NAME']
        self.max_pool_size = Settings.CE['MAX_POOL_SIZE']
        self.log_path = Settings.LOG_PATH_PRD2
        self.urls = Settings.CE['URLS']
        self.restart_path = Settings.CE['RESTART_PATH']
        self.restart_interval = Settings.CE['RESTART_INTERVAL']
