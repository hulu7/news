...
class Camel():
    def __init__(self):
        ...
        self.camelBone = CamelBone('yixieshi', callback=self.parse)
    ...
    def parse(self, current_url, html):
        results = []
        href_items = []
        href_items0_1 = html.xpath(".//*[contains(@class, 'col-md-8')]/h2//a")
        ...
        for item in href_items:
            ...
            if valid:
                ...
                id = short_url_parts[short_url_parts.index('yixieshi') + 2]
