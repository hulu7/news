...
class BaiJia():
    ...
    def getSettings(self):
        self.settings = self.globalSettings.CreateSettings('baijia')
    ...
    def parse(self, response):
        ...
        del current_url, html, title, url, href_url, id, href_items, short_url_parts, title_list1
        gc.collect()
