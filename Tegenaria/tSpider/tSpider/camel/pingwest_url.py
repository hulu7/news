...
class Camel():
    def __init__(self):
        ...
        self.camelBone = CamelBone('pingwest', callback=self.parse)
        self.regx = re.compile("\/\/www\.pingwest\.com\/a\/[0-9]{0,}")
        self.badkeys = []
        self.goodkeys = []
    ...
    def parse(self, current_url, html):
        results = []
        href_items = []
        href_items0_1 = html.xpath(".//*[contains(@class, 'title')]/a")
        ...
        for item in href_items:
            ...
            if valid:
                ...
                id = short_url_parts[short_url_parts.index('pingwest') + 3]
