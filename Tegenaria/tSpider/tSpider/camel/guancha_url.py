...
class Guancha():
    def getSettings(self):
        self.work_path_prd2 = Settings.GUANCHA['WORK_PATH_PRD2']
        self.finished_url_path = Settings.GUANCHA['FINISHED_URL_PATH']
        self.mongo = Settings.GUANCHA['MONGO_URLS']
        self.name = Settings.GUANCHA['NAME']
        self.max_pool_size = Settings.GUANCHA['MAX_POOL_SIZE']
        self.log_path = Settings.LOG_PATH_PRD2
        self.urls = Settings.GUANCHA['URLS']
        self.restart_path = Settings.GUANCHA['RESTART_PATH']
        self.restart_interval = Settings.GUANCHA['RESTART_INTERVAL']
