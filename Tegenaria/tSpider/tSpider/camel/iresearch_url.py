...
class Iresearch():
    ...
    def getSettings(self):
        self.work_path_prd2 = Settings.IRESEARCH['WORK_PATH_PRD2']
        self.mongo = Settings.IRESEARCH['MONGO_URLS']
        self.name = Settings.IRESEARCH['NAME']
        self.max_pool_size = Settings.IRESEARCH['MAX_POOL_SIZE']
        self.log_path = Settings.LOG_PATH_PRD2
        self.urls = Settings.IRESEARCH['URLS']
        self.restart_path = Settings.IRESEARCH['RESTART_PATH']
        self.restart_interval = Settings.IRESEARCH['RESTART_INTERVAL']
