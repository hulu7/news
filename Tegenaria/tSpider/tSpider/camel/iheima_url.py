...
class Iheima():
    ...
    def getSettings(self):
        self.work_path_prd2 = Settings.IHEIMA['WORK_PATH_PRD2']
        self.mongo = Settings.IHEIMA['MONGO_URLS']
        self.name = Settings.IHEIMA['NAME']
        self.max_pool_size = Settings.IHEIMA['MAX_POOL_SIZE']
        self.log_path = Settings.LOG_PATH_PRD2
        self.urls = Settings.IHEIMA['URLS']
        self.restart_path = Settings.IHEIMA['RESTART_PATH']
        self.restart_interval = Settings.IHEIMA['RESTART_INTERVAL']
