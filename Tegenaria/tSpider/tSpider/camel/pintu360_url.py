...
class Camel():
    def __init__(self):
        ...
        self.camelBone = CamelBone('pintu360', callback=self.parse)
        self.regx = re.compile("[0-9a-zA-Z]{0,}.html\?s\=[0-9\,]{0,}\&o\=[0-9\,]{0,}")
        self.badkeys = []
        self.goodkeys = []
    ...
    def parse(self, current_url, html):
        results = []
        href_items = []
        href_items0_1 = html.xpath(".//.//*[contains(@class, 'article-title')]/a")
